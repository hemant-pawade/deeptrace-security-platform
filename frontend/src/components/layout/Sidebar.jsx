...
export function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#0B0F17] border-r border-slate-800/80 flex flex-col shrink-0 min-h-screen transition-transform duration-200 ease-in-out md:static md:translate-x-0 ${
